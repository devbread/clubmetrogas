...
function initBt2() {
  ...
  var bt1c = document.querySelector('.button__container');
  var $circlesTopLeft = bt2.querySelectorAll('.circle.top-left');
  var $circlesBottomRight = bt2.querySelectorAll('.circle.bottom-right');
  ...
  tlBt2.set($circlesTopLeft, { x: 0, y: 0, rotation: -45 });
  tlBt2.add(tl);
